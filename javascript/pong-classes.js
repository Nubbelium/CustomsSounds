...
export class Game {
  constructor(
    ...
    this.size = { x: 1000, y: 800 }; //container for entire game
    ...
    this.volume = 7; //default volume output 0-10
    this.computerState = 5  ; //default computer control amount
...
export class Ball {
  constructor(
    ...
    this.acceleration = 1.01; //X speed multipler on successful block
...
export class Paddle {
  constructor(
    ...
    this.size = { x: 10, y: 125 }; //default paddle size
